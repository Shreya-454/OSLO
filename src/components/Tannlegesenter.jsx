...
const Tannlegesenter = () => {
  return (
    <div className=' bg-blue relative z-[1] '>
      <div className="container max-w-[1568px] sm:px-6 px-3 mx-auto">
<div className="w-full bg-pink border-8 md:border-[16px] border-solid 2xl:max-w-[1520px] xl:max-w-[1100px] mx-auto lg:max-w-[900px]  border-white rounded-[96px] py-[100px] md:py-[164px] md:px-6 px-3 relative">
