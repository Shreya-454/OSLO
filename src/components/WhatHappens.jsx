...
const WhatHappens = () => {
  return (
    <div className=' overflow-x-clip xl:pt-[221px] md:pt-0 sm:pt-20 pt-10 lg:mt-[307px] md:mt-[180px] sm:pb-20 pb-12 lg:pb-[135px]' >
      <div className="container 2xl:max-w-[1568px] max-w-[1320px] mx-auto sm:px-6 px-3">
        <div className="flex flex-row flex-wrap -mx-3 items-center">
            ...
            <div className="sm:flex gap-9">
                ...
                <div className=' mt-[22px]'>
                    <h4 className=' text-skyBlue text-xl sm:text-2xl md:text-3xl font-avenir text-center sm:text-start lg:mb-10 sm:mb-5 mb-3 font-extrabold'>Bacteria and infections</h4>
            ...
            <img src={whatHappenImg} alt="whatImg" className='max-w-[795.57px] 2xl:mb-[128px] max-h-[726.8px] min-[1600px]:w-auto w-full xl:object-contain mx-auto 2xl:mx-0 max-xl:translate-x-7'  />
            </div>
        </div>
         </div>
    </div>
