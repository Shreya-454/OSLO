...
const WhatHappens = () => {
  return (
    <div className=' xl:pt-[221px] md:pt-0 sm:pt-20 pt-10 lg:mt-[307px] md:mt-[180px] sm:pb-20 pb-12 lg:pb-[135px]' >
      <div className="container max-w-[1568px] mx-auto sm:px-6 px-3">
        <div className="flex flex-row flex-wrap -mx-3">
            <div className="xl:w-7/12 w-full px-3 mb-8 xl:mb-0">
            ...
            <div className="xl:w-5/12 w-full px-3 relative z-[1]">
